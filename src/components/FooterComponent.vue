<template lang="">
    <div class="lg:block hidden px-16 py-10">
        <div class="px-16 py-10 flex gap-24 justify-between bg-[#F9FFF6] rounded-2xl">
            ...
            <div class="flex flex-col gap-3 w-[15%]">
                <h2 class="font-medium text-[#333333] text-lg">About Us</h2>
                <ul class="flex flex-col text-sm gap-2 text-[#757575]">
                    <li>About Us</li>
                    <li>FAQ</li>
            ...
            <div class="flex flex-col gap-3 w-[30%]">
                <h2 class="font-medium text-[#333333] text-lg">Newsletter</h2>
                <p class="text-sm text-[#757575]">Get now free 50% discount for alll products on your first order</p>
                <div class="relative flex flex-wrap items-stretch">
                    <input
                    type="text"
                    class="relative text-sm m-0 -mr-0.5 block w-[1px] min-w-0 flex-auto rounded-l-lg border border-solid border-neutral-300 bg-transparent bg-clip-padding px-3 py-[0.25rem] text-base font-normal leading-[1.6] text-black outline-none transition duration-200 ease-in-out focus:z-[3] focus:border-primary focus:text-black focus:shadow-[inset_0_0_0_1px_rgb(59,113,202)] focus:outline-none dark:border-neutral-600 dark:text-black dark:placeholder:text-black dark:focus:border-primary"
                    placeholder="Your email address"
                    aria-label="Your email address"
                    aria-describedby="button-addon2" />
                    <button
                    class="mt-0 z-[2] inline-block rounded-r-lg bg-[#8BAC3E] px-6 py-[0.25rem] text-xs font-medium uppercase leading-normal text-white"
                    data-te-ripple-init
                    type="button"
                    id="button-addon2">
                    SEND
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <span class="text-sm">elemesid@gmail.com</span>
                    </div>
                    <div class="flex items-center gap-2">
                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <span class="text-sm"> 0888 1111 2222 </span>
                    </div>
                </div>
            </div>
        </div>
        <div class="flex justify-center w-full">
            <span class="text-[#757575] text-xs">© 2021 Elemes id. All rights reserved</span>
        </div>
    </div>
    <!-- Navigation Mobile -->
    <div class="lg:hidden flex bg-white w-full fixed bottom-0 justify-between px-8 py-2">
